...
const ImageComponent = ({score}) => {
    ...
    useEffect(()=>{
        ...
        if (score<100){
            ...
            setInfo3("State Farm will continue to insure your automobile adventures!");
        }
        else if (score<300){
            ...
            setInfo2("Unfortunately State Farm will drop you due to your many accidents.");
            setInfo3("We have the priority to protect other people from you on the road.");
        }
    ...
    return (
        ...
        <div className = "container2">
            <img src= "ending.jpg" alt="Title Screen of State Farm Road Quest" className = "endingpage"/>
