...
var Phaser$1 = require('phaser');
var Reconciler = _interopDefault(require('react-reconciler'));
var performanceNow = _interopDefault(require('performance-now'));
...
function useInputEvent(event, callback) {
  var scene = useScene();
  React.useEffect(function () {
    !!!scene ?  invariant(false, '`useInputEvent` could not find the scene. Make sure it is used in a component that is a child of <Scene />')  : void 0;
...
function useKeyboardEvent(event, callback) {
  var scene = useScene();
  React.useEffect(function () {
    !!!scene ?  invariant(false, '`useKeyboardEvent` could not find the scene. Make sure it is used in a component that is a child of <Scene />')  : void 0;
...
function useGamepadEvent(event, callback) {
  var scene = useScene();
  React.useEffect(function () {
    !!!scene ?  invariant(false, '`useGamepadEvent` could not find the scene. Make sure it is used in a component that is a child of <Scene />')  : void 0;
...
function useArcadeCollider(obj1, obj2, args) {
  ...
  var scene = useScene();
  var collider = React.useRef(null);
...
function useSpawner() {
  return React.useContext(SpawnerContext);
}
...
function useGameObject() {
  return React.useContext(GameObjectContext);
}
...
function ArcadeImage(props, ref) {
  ...
  var instance = React.useMemo(function () {
    return props.instance || new Phaser$1.Physics.Arcade.Image(scene, props.x, props.y, props.texture, props.frame);
  }, []);
  React.useImperativeHandle(ref, function () {
    return instance;
  });
...
function Sprite(_ref, ref) {
  ...
  var scene = useScene();
  var instance = React.useMemo(function () {
    return props.instance || new Phaser$1.GameObjects.Sprite(scene, props.x, props.y, props.texture, props.frame);
  }, []);
  React.useImperativeHandle(ref, function () {
    return instance;
  });
...
function ArcadeSprite(props, ref) {
  var scene = useScene();
  var instance = React.useMemo(function () {
    return props.instance || new Phaser$1.Physics.Arcade.Sprite(scene, props.x, props.y, props.texture, props.frame);
  }, []);
  React.useImperativeHandle(ref, function () {
    return instance;
...
var module$1 = "dist/react-phaser-fiber.esm.js";
...
function insertBefore(parent, child, beforeChild) {
  !(child !== beforeChild) ?  invariant(false, 'PhaserFiber cannot insert node before itself')  : void 0;
...
var hostconfig = {
  ...
  createTextInstance: function createTextInstance(text, rootContainerInstance, internalInstanceHandler) {
      invariant(false, 'react-phaser does not support text instances. Use `<Text /> component` instead.')  ;
  },
...
function (_React$Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.game = new Phaser$1.Game(_extends({}, config));
...
function Image(props, ref) {
  var scene = useScene();
  var instance = React.useMemo(function () {
    return props.instance || new Phaser$1.GameObjects.Image(scene, props.x, props.y, props.texture, props.frame);
  }, []);
  React.useImperativeHandle(ref, function () {
    return instance;
  });
...
function Scene(_ref, ref) {
  ...
  var _useState = React.useState(!!onPreload),
      loading = _useState[0],
  ...
  var scene = React.useMemo(function () {
    var instance = new Phaser$1.Scene(_extends({}, options, {
      key: sceneKey
    })); // @ts-ignore
...
var withSpawner = function withSpawner(Component) {
  function WithSpawner(props) {
    return React.createElement(SpawnerContext.Consumer, null, function (spawner) {
...
function Text(props, ref) {
  var scene = useScene();
  var instance = React.useMemo(function () {
    return props.instance || new Phaser$1.GameObjects.Text(scene, props.x, props.y, props.text, props.style);
  }, []);
  React.useImperativeHandle(ref, function () {
    return instance;
  });
...
exports.ArcadeCollider = ArcadeCollider;
exports.ArcadeImage = ArcadeImage$1;
exports.ArcadeSprite = ArcadeSprite$1;
exports.Game = Game;
exports.GameObject = GameObject$1;
exports.GameObjectContext = GameObjectContext;
exports.Group = Group$1;
exports.Image = Image$1;
exports.Scene = Scene$1;
exports.Spawner = Spawner;
exports.SpawnerContext = SpawnerContext;
exports.Sprite = Sprite$1;
exports.Text = Text$1;
exports.findGameObjectsByName = findGameObjectsByName;
exports.useArcadeCollider = useArcadeCollider;
...
exports.useGamepadEvent = useGamepadEvent;
...
exports.useSpawner = useSpawner;
exports.withSpawner = withSpawner;
//# sourceMappingURL=react-phaser-fiber.cjs.development.js.map
